...
/* FIRST TRY
createFailingStudentComponent = (student) => {
  return `
      <div class="student">
...
createPassingStudentComponent = (student) => {
  return `
      <div class="student">
...
createStudentComponent = (student) => {
  return `
    <div class="student">
      ...
      <section class="${student.section}">${student.subject}</section>
      <aside class="${student.aside}">${student.info}</aside>
  </div>`
}
...
for (const student of students) {
  ...
  if (student.score >= 60) {
      student.status = "passing xx-large"
      student.section = "bordered dashed section--padded"
      student.aside = "pushRight"
